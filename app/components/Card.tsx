...
const $containerBase: ViewStyle = {
  ...
  borderWidth: 1,
  shadowColor: colors.palette.dark100,
...
const $containerPresets = {
  default: [
    $containerBase,
    {
      backgroundColor: colors.palette.dark200,
      borderColor: colors.palette.dark200,
    },
  ] as StyleProp<ViewStyle>,

  reversed: [
    $containerBase,
    { backgroundColor: colors.palette.dark200, borderColor: colors.palette.dark200 },
  ] as StyleProp<ViewStyle>,
}

const $headingPresets: Record<Presets, TextStyle> = {
  default: {},
  reversed: { color: colors.palette.light100 },
}
